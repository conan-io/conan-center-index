...
int test_mz_compat() {
  {
    ...
    zipFile zf = zipOpen64("compat.zip", APPEND_STATUS_CREATE);
    if (zf == NULL) {
  ...
  }
  {
    ...
    unzFile zf = unzOpen64("compat.zip");
    if (zf == NULL) {
...
int test_mz_strm() {
...

  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", "compressed.buffered");
  ...
  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", "compressed.zlib");
  ...
  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", "compressed.lzma");
  ...
  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", "compressed.bzip");
  ...
  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", "compressed.zstd");
  ...
  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", "compressed.wzaes");
  ...
  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", "compressed.libcomp");
...
int test_mz_zip() {
  ...
  int err = 0;
  void *zipHandle = NULL;
  char filename_in_zip[] = "uncompressed.txt";
  char data[] =
      "Hello, World!\nHello, World!\nHello, World!\nHello, World!\nHello, "
      "World!\nHello, World!\nHello, World!\nHello, World!\nHello, World!\n";
  ...
  struct PipelineElement os_pipe =
      createPipelineElement(mz_stream_os_create, "os", "compressed.zip");
