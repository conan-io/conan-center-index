...
int test_mz_compat() {
  {
    ...
    zipFile zf = zipOpen64(u8"\U0001F0C1_compat.zip", APPEND_STATUS_CREATE);
    if (zf == NULL) {
  ...
  }
  {
    ...
    unzFile zf = unzOpen64(u8"\U0001F0C1_compat.zip");
    if (zf == NULL) {
...
int test_mz_strm() {
...

  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", u8"\U0001F0C1.buffered");
  ...
  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", u8"\U0001F0C1.zlib");
  ...
  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", u8"\U0001F0C1.lzma");
  ...
  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", u8"\U0001F0C1.bzip");
  ...
  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", u8"\U0001F0C1.zstd");
  ...
  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", u8"\U0001F0C1.wzaes");
  ...
  {
    struct PipelineElement os_pipe =
        createPipelineElement(mz_stream_os_create, "os", u8"\U0001F0C1.libcomp");
...
int test_mz_zip() {
  ...
  int err = 0;
  void *zipHandle = NULL;
  char filename_in_zip[] = u8"\U0001F0C1.txt";
  char data[] =
      "Hello, World!\nHello, World!\nHello, World!\nHello, World!\nHello, "
      "World!\nHello, World!\nHello, World!\nHello, World!\nHello, World!\n";
  ...
  struct PipelineElement os_pipe =
      createPipelineElement(mz_stream_os_create, "os", u8"\U0001F0C1.zip");
