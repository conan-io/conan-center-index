...
class MinizipConan(ConanFile):
    ...
    def _configure_cmake(self):
        if not self._cmake:
            ...
            self._cmake.definitions["MZ_OPENSSL"] = self._with_openssl
    ...
    def build(self):
        ...
        tools.replace_in_file(self._source_subfolder + "/CMakeLists.txt", "target_link_libraries(${PROJECT_NAME} libbsd::libbsd)", "target_link_libraries(${PROJECT_NAME} libbsd::libbsd)")
