...
class SpirvCrossConan(ConanFile):
    name = "diligentgraphics-spirv-cross"
    description = "Diligent fork. SPIRV-Cross is a practical tool and library for performing " \
                  "reflection on SPIR-V and disassembling SPIR-V back to high level languages."
    license = "Apache-2.0"
    topics = ("conan", "spirv-cross", "reflection", "disassembler", "spirv", "spir-v", "glsl", "hlsl", "diligent")
    homepage = "https://github.com/DiligentGraphics/SPIRV-Cross/"
