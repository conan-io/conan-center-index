...
class OpenSSLConan(ConanFile):
    ...
    def _create_cmake_module_variables(self, module_file):
        content = textwrap.dedent("""\
            ...
            elseif(DEFINED quictls-openssl_OpenSSL_Crypto_LIBS_%(config)s)
                set(OPENSSL_CRYPTO_LIBRARY ${quictls-openssl_OpenSSL_Crypto_LIBS_%(config)s})
                set(OPENSSL_CRYPTO_LIBRARIES ${quictls-openssl_OpenSSL_Crypto_LIBS_%(config)s}
                                             ${quictls-openssl_OpenSSL_Crypto_DEPENDENCIES_%(config)s}
                                             ${quictls-openssl_OpenSSL_Crypto_FRAMEWORKS_%(config)s}
                                             ${quictls-openssl_OpenSSL_Crypto_SYSTEM_LIBS_%(config)s})
            endif()
            ...
            elseif(DEFINED quictls-openssl_OpenSSL_SSL_LIBS_%(config)s)
                set(OPENSSL_SSL_LIBRARY ${quictls-openssl_OpenSSL_SSL_LIBS_%(config)s})
                set(OPENSSL_SSL_LIBRARIES ${quictls-openssl_OpenSSL_SSL_LIBS_%(config)s}
                                          ${quictls-openssl_OpenSSL_SSL_DEPENDENCIES_%(config)s}
                                          ${quictls-openssl_OpenSSL_SSL_FRAMEWORKS_%(config)s}
                                          ${quictls-openssl_OpenSSL_SSL_SYSTEM_LIBS_%(config)s})
            endif()
