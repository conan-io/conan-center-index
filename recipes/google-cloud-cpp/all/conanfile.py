...
class GoogleCloudCppConan(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.components["logging_type_type_protos"].requires = ["grpc::grpc++", "grpc::grpc", "protobuf::libprotobuf", "api_annotations_protos"]
        self.cpp_info.components["logging_type_type_protos"].libs = ["google_cloud_cpp_logging_type_type_protos"]
        self.cpp_info.components["logging_type_type_protos"].names["pkg_config"] = "google_cloud_cpp_logging_type_type_protos"

        self.cpp_info.components["logging_protos"].requires = ["grpc::grpc++", "grpc::grpc", "protobuf::libprotobuf", "api_annotations_protos", "api_client_protos", "api_distribution_protos", "api_field_behavior_protos", "api_metric_protos", "api_monitored_resource_protos", "api_resource_protos", "logging_type_type_protos", "rpc_status_protos"]
