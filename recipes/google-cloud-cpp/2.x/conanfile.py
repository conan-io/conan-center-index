...
class GoogleCloudCppConan(ConanFile):
    ...
    def _proto_components(self):
        ...
        if Version(self.version) <= '2.19.0':
            # Handling of these proto libraries was simplified in the 2.23.0
