...
class Allegro5Conan(ConanFile):
    ...
    def _patch_addon(self, addon, find, replace):
        tools.replace_in_file(os.path.join("../source", self._source_subfolder, "addons", addon, "CMakeLists.txt"), find, replace, strict=False)
    ...
    def _patch_sources(self):
        ...
        self._patch_addon("acodec", "find_package(FLAC)", "find_package(FLAC)\nset(FLAC_STATIC 1)\n")
        ...
        self._patch_addon("acodec", "find_package(Opus)", "find_package(Opus)\nfind_package(opusfile)")
    ...
    def _configure_cmake(self):
        ...
        # Disable warnings: possible loss of data, signed/unsigned comparison, unused variables, preprocessor
        self._cmake.definitions["CMAKE_CXX_FLAGS"] = "/wd4267 /wd4018" if self._is_msvc else "-Wno-unused-variable -Wp,-w"
