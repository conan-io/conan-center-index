...
class GtkConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("glib/2.78.3", transitive_headers=True, transitive_libs=True, force=True)  # FIXME: bump gdk-pixbuf deps
    ...
    def build_requirements(self):
        ...
        if self._gtk4:
            self.tool_requires("libxml2/2.12.4")  # for xmllint
