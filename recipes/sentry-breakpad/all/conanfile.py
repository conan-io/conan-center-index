...
class SentryBreakpadConan(ConanFile):
    ...
    def requirements(self):
        if self.settings.os in ("FreeBSD", "Linux"):
            self.requires("linux-syscall-support/cci.20200813", transitive_headers=True) #https://github.com/conan-io/conan-center-index/pull/16752#issuecomment-1487241864 
