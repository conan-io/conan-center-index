...
class AwsCrtCpp(ConanFile):
    ...
    def requirements(self):
        if self.version == "0.26.9":
            ...
            self.requires("aws-c-cal/0.6.14", transitive_headers=True)
            self.requires("aws-c-compression/0.2.18", transitive_headers=True)
            ...
            self.requires("aws-checksums/0.1.18", transitive_headers=True)
            self.requires("aws-c-event-stream/0.4.2", transitive_headers=True)
            self.requires("aws-c-s3/0.5.5", transitive_headers=True)
        if self.version == "0.17.1a":
            ...
            self.requires("aws-c-cal/0.5.12", transitive_headers=True)
            self.requires("aws-c-compression/0.2.14", transitive_headers=True)
            ...
            self.requires("aws-checksums/0.1.12", transitive_headers=True)
            self.requires("aws-c-event-stream/0.2.7", transitive_headers=True)
            self.requires("aws-c-s3/0.1.26", transitive_headers=True)
