...
class SqlcipherConan(ConanFile):
    ...
    def validate(self):
        if self.options.crypto_library == "commoncrypto" and not tools.is_apple_os(self, self.settings.os):
    ...
    def _use_commoncrypto(self):
        return self.options.crypto_library == "commoncrypto" and tools.is_apple_os(self, self.settings.os)
    ...
    def package_info(self):
        ...
        if self.settings.os in ["Linux", "FreeBSD"]:
            ...
            if tools.scm.Version(self, self.version) >= "4.5.0":
