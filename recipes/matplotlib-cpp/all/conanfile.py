...
class MatplotlibCppConan(ConanFile):
    ...
    license = "MIT"
    topics = ("matplotlib", "plotting", "chart", "data-visualization")
    ...
    def package(self):
        ...
        copy(self, "matplotlibcpp.h", src=self.source_folder, dst=os.path.join(self.package_folder, "include"))
    ...
    def package_info(self):
        ...
        self.cpp_info.names["cmake_find_package"] = "matplotlib_cpp"
        self.cpp_info.names["cmake_find_package_multi"] = "matplotlib_cpp"
