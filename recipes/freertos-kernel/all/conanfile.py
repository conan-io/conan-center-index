...
port_include_directories = {
    "BCC_16BIT_DOS_FLSH186": [os.path.join("BCC", "16BitDOS", "common"), os.path.join("BCC", "16BitDOS", "Flsh186")],
    "BCC_16BIT_DOS_PC": [os.path.join("BCC", "16BitDOS", "common"), os.path.join("BCC", "16BitDOS", "PC")],
    ...
    "GCC_ARM_CA53_64_BIT": [os.path.join("GCC", "ARM_CA53_64_BIT")],
    "GCC_ARM_CA53_64_BIT_SRE": [os.path.join("GCC", "ARM_CA53_64_BIT_SRE")],
    ...
    "GCC_RISC_V": [os.path.join("GCC", "RISC-V"), os.path.join("GCC", "RISC-V", "chip_specific_extensions", "RISCV_MTIME_CLINT_no_extensions")],
    "GCC_RISC_V_PULPINO_VEGA_RV32M1RM": [os.path.join("GCC", "RISC-V"), os.path.join("GCC", "RISC-V", "chip_specific_extensions", "Pulpino_Vega_RV32M1RM")],
    ...
    "GCC_POSIX": [os.path.join("ThirdParty", "GCC", "Posix"), os.path.join("ThirdParty", "GCC", "Posix", "utils")],
    "GCC_RP2040": [os.path.join("ThirdParty", "GCC", "RP2040", "include")],
    "GCC_XTENSA_ESP32": [os.path.join("ThirdParty", "GCC", "Xtensa_ESP32"), os.path.join("ThirdParty", "GCC", "Xtensa_ESP32", "include")],
    ...
    "IAR_RISC_V": [os.path.join("IAR", "RISC-V"), os.path.join("IAR", "RISC-V", "chip_specific_extensions", "RV32I_CLINT_no_extensions")],
    ...
    "OWATCOM_16BIT_DOS_FLSH186": [os.path.join("oWatcom", "16BitDOS", "common"), os.path.join("oWatcom", "16BitDOS", "Flsh186")],
    "OWATCOM_16BIT_DOS_PC": [os.path.join("oWatcom", "16BitDOS", "common"), os.path.join("oWatcom", "16BitDOS", "PC")],
...
class FreeRTOSKernelConan(ConanFile):
    ...
    options = {
        ...
        "enable_errata_837070_workaround": [True, False],
        ...
        "include_uxTaskGetStackHighWaterMark2": [True, False],
    ...
    default_options = {
        ...
        "include_uxTaskGetStackHighWaterMark2": False,
    ...
    def _patch_sources(self):
        ...
        for option, value in self.options.items():
            ...
            if value in ["True", "true"]:
                ...
                value = "0"
            replace_in_file(self, os.path.join(self.build_folder, "FreeRTOSConfig.h"), key, value)
    ...
    def package(self):
        ...
        for include_directory in port_include_directories[str(self.options.port)]:
            copy(self, "*.h", os.path.join(self.source_folder, "portable", include_directory), os.path.join(self.package_folder, "include"), keep_path=False)
