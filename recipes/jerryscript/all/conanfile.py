...
class JerryScriptStackConan(ConanFile):
    ...
    def config_options(self):
        ...
        if tools.scm.Version(self.version) < "2.4.0":
    ...
    def _configure_cmake(self):
        ...
        if tools.scm.Version(self.version) < tools.scm.Version("2.4.0"):
    ...
    def package_info(self):
        ...
        if self._jerry_math:
            mathlibname = "jerry-libm" if tools.scm.Version(self.version) < "2.4.0" else "jerry-math"
