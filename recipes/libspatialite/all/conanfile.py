...
class LibspatialiteConan(ConanFile):
    ...
    def _patch_sources(self):
        ...
        if is_msvc(self):
            ...
            #                     "AC_CHECK_LIB(z,",
            #                     "AC_CHECK_LIB({},".format(self.dependencies.direct_host["zlib"].cpp_info.libs[0]))
    ...
    def package(self):
        ...
        if is_msvc(self):
            copy(self, "spatialite.h", os.path.join(self.source_folder, "src", "headers"), os.path.join(self.package_folder, "include"))
            copy(self, "*.h", os.path.join(self.source_folder, "src", "headers", "spatialite"), os.path.join(self.package_folder, "include", "spatialite"))
