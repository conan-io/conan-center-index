...
class EdlibConan(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.set_property("pkg_config_name", "edlib-{}".format(tools.scm.Version(self.version).major))
        self.cpp_info.names["pkg_config"] = "edlib-{}".format(tools.scm.Version(self.version).major)
