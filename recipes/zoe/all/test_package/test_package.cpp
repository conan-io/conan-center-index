...
#else
  efd.setThreadNum(10);                     // Optional
  efd.setExpiredTimeOfTmpFile(3600);          // Optional
  efd.setDiskCacheSize(20 * (2 << 19));     // Optional
  efd.setMaxDownloadSpeed(50 * (2 << 19));  // Optional
  efd.setHashVerifyPolicy(HashVerifyPolicy::AlwaysVerify, HashType::MD5, "6fe294c3ef4765468af4950d44c65525"); // Optional, support MD5, CRC32, SHA256
#endif
