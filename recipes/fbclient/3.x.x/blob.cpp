...
/*********** Preprocessed module -- do not edit ***************/
/*********** Preprocessed module -- do not edit ***************/
/***************** gpre version LI-V3.0.8.33535 Firebird 3.0 **********************/
/*
											...
											ISC_BLOB_DESC* desc, UCHAR* global)
{
   struct isc_4_struct {
          ...
          short isc_6;	/* RDB$SEGMENT_LENGTH */
          short isc_7;	/* RDB$CHARACTER_SET_ID */
          short isc_8;	/* RDB$FIELD_SUB_TYPE */
          char  isc_9 [125];	/* RDB$FIELD_NAME */
   } isc_4;
   struct isc_1_struct {
          char  isc_2 [125];	/* RDB$PROCEDURE_NAME */
          char  isc_3 [125];	/* RDB$PARAMETER_NAME */
   } isc_1;
   struct isc_14_struct {
          short isc_15;	/* isc_utility */
          short isc_16;	/* RDB$SEGMENT_LENGTH */
          short isc_17;	/* RDB$CHARACTER_SET_ID */
          short isc_18;	/* RDB$FIELD_SUB_TYPE */
          char  isc_19 [125];	/* RDB$FIELD_NAME */
   } isc_14;
   struct isc_11_struct {
          char  isc_12 [125];	/* RDB$RELATION_NAME */
          char  isc_13 [125];	/* RDB$FIELD_NAME */
   } isc_11;
/***********************************************
 *
 ...
 ***********************************************/
	...
	isc_vtov ((const char*) desc->blob_desc_relation_name, (char*) isc_11.isc_12, 125);
	isc_vtov ((const char*) desc->blob_desc_field_name, (char*) isc_11.isc_13, 125);
	if (handle)
	   {
	   isc_start_and_send (isc_status, (FB_API_HANDLE*) &handle, (FB_API_HANDLE*) &*trans_handle, (short) 0, (short) 250, &isc_11, (short) 0);
	   }
	if (!isc_status [1]) {
	while (1)
	   {
	   isc_receive (isc_status, (FB_API_HANDLE*) &handle, (short) 1, (short) 133, &isc_14, (short) 0);
	   if (!isc_14.isc_15 || isc_status [1]) break;
		flag = true;
        ...
        if (global) {
            copy_exact_name((UCHAR*) /*Y.RDB$FIELD_NAME*/
				     isc_14.isc_19, global, sizeof(/*Y.RDB$FIELD_NAME*/
		 isc_14.isc_19));
        }
	/*END_FOR*/
	   }
	...
	if (!flag)
	{
		...
		isc_vtov ((const char*) desc->blob_desc_relation_name, (char*) isc_1.isc_2, 125);
		isc_vtov ((const char*) desc->blob_desc_field_name, (char*) isc_1.isc_3, 125);
		if (handle)
		   {
		   isc_start_and_send (isc_status, (FB_API_HANDLE*) &handle, (FB_API_HANDLE*) &*trans_handle, (short) 0, (short) 250, &isc_1, (short) 0);
		   }
		if (!isc_status [1]) {
		while (1)
		   {
		   isc_receive (isc_status, (FB_API_HANDLE*) &handle, (short) 1, (short) 133, &isc_4, (short) 0);
		   if (!isc_4.isc_5 || isc_status [1]) break;
			...
			if (global)
				copy_exact_name((UCHAR*) /*Y.RDB$FIELD_NAME*/
							 isc_4.isc_9, global, sizeof(/*Y.RDB$FIELD_NAME*/
		 isc_4.isc_9));
		/*END_FOR*/
		   }
		   };
