 ...
 **************************************/
	...
	isc_vtov ((const char*) global, (char*) isc_12.isc_13, 125);
	if (handle)
	   {
	   isc_start_and_send (isc_status, (FB_API_HANDLE*) &handle, (FB_API_HANDLE*) &*trans_handle, (short) 0, (short) 125, &isc_12, (short) 0);
	   }
	if (!isc_status [1]) {
	while (1)
	   {
						  ...
						  SCHAR* global)
{
   struct isc_4_struct {
          ...
          short isc_6;	/* RDB$DIMENSIONS */
          short isc_7;	/* RDB$FIELD_LENGTH */
          short isc_8;	/* RDB$FIELD_SCALE */
          short isc_9;	/* RDB$FIELD_TYPE */
          char  isc_10 [125];	/* RDB$FIELD_NAME */
   } isc_4;
   struct isc_1_struct {
          char  isc_2 [125];	/* RDB$RELATION_NAME */
          char  isc_3 [125];	/* RDB$FIELD_NAME */
   } isc_1;
/**************************************
 *
 ...
 **************************************/
	...
	isc_vtov ((const char*) desc->array_desc_relation_name, (char*) isc_1.isc_2, 125);
	isc_vtov ((const char*) desc->array_desc_field_name, (char*) isc_1.isc_3, 125);
	if (handle)
	   {
	...
	while (1)
	   {
	   isc_receive (isc_status, (FB_API_HANDLE*) &handle, (short) 1, (short) 135, &isc_4, (short) 0);
	   if (!isc_4.isc_5 || isc_status [1]) break;
        ...
        if (global) {
            copy_exact_name (/*Y.RDB$FIELD_NAME*/
			     isc_4.isc_10, global, sizeof(/*Y.RDB$FIELD_NAME*/
		 isc_4.isc_10));
        }
