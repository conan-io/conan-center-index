...
class ConanFile(ConanFile):
    ...
    def package_info(self):
        ...
        if ((self.settings.os == "Macos" and self.settings.os.version and tools.Version(self.settings.os.version.value) >= "10.8")
                or (self.settings.os == "iOS" and tools.Version(self.settings.os.version.value) >= "6.0")):
        ...
        if self.settings.os == "Macos" and self.settings.os.version and tools.Version(self.settings.os.version.value) <= "10.6" and self.settings.arch == "x86":
