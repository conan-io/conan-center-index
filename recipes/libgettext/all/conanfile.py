...
class GetTextConan(ConanFile):
    ...
    def package(self):
        ...
        source_libintl_dir = os.path.join(self.source_folder, "gettext-runtime", "intl")
        copy(self, "COPYING.LIB", source_libintl_dir, os.path.join(self.package_folder, "licenses"))
