...
class OpenCascadeConan(ConanFile):
    ...
    def generate(self):
        ...
        # 3RDPARTY_DIR 
        tc.variables["3RDPARTY_DIR"] = os.getenv('CONAN_HOME', '~/.conan2/')

        tcl = self.dependencies['tcl'].cpp_info
        tc.variables["3RDPARTY_TCL_DIR"] = tcl.libdirs[0]+"/.."
        ...
        tc.variables["3RDPARTY_FREETYPE_DIR"] = freetype.libdirs[0]+"/.."
        ...
        if self._is_linux:
            ...
            tc.variables["3RDPARTY_FONTCONFIG_DIR"] = fontconfig.libdirs[0]+"/.."
        ...
        if self._link_tk:
            ...
            tc.variables["3RDPARTY_TK_DIR"] = tk.libdirs[0]+"/.."
        ...
        if self.options.with_openvr:
            ...
            tc.variables["3RDPARTY_OP_DIR"] = openvr.libdirs[0]+"/.."
        ...
        if self.options.with_rapidjson:
            ...
            tc.variables["3RDPARTY_RAPIDJSON_DIR"] = rapidjson.libdirs[0]+"/.."
            tc.variables["3RDPARTY_RAPIDJSON_LIBRARY"] = rapidjson.libdirs[0]
            tc.variables["3RDPARTY_RAPIDJSON_INCLUDE_DIR"] = rapidjson.includedirs[0]

        if self.options.get_safe("with_draco"):
            draco = self.dependencies['draco'].cpp_info
            tc.variables["3RDPARTY_DRACO_DIR"] = draco.libdirs[0]+"/.."
