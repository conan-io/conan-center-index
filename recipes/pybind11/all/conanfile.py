...
class PyBind11Conan(ConanFile):
    ...
    def package(self):
        ...
        cmake = self._configure_cmake()
        cmake.install()
        os.unlink(os.path.join(self.package_folder, "lib", "cmake", "pybind11", "pybind11Common.cmake"))
        os.unlink(os.path.join(self.package_folder, "lib", "cmake", "pybind11", "pybind11NewTools.cmake"))
        os.unlink(os.path.join(self.package_folder, "lib", "cmake", "pybind11", "pybind11Targets.cmake"))
