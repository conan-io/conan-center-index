...
class Mosquitto(ConanFile):
    ...
    def requirements(self):
        ...
        if self.options.threading and Version(self.version) >= "2.0.20" and self.settings.os == "Windows":
    ...
    def generate(self):
        ...
        if Version(self.version) >= "2.0.20":
...
""")
    ...
    def package_info(self):
        ...
        if self.settings.os == "Linux":
            ...
            if self.options.threading and Version(self.version) >= "2.0.20":
