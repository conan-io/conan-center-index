...
class IXWebSocketConan(ConanFile):
    ...
    def config_options(self):
        ...
        if tools.scm.Version(self.version) < "10.1.5":
    ...
    def _can_use_openssl(self):
        if self.settings.os == "Windows":
            ...
            return tools.scm.Version(self.version) >= "7.9.3"
    ...
    def validate(self):
        if self.settings.compiler.get_safe("cppstd"):
            ...
            tools.build.check_min_cppstd(self, self, 14 if tools.scm.Version(self.version) < "11.0.8" else 11)
        if self.options.tls == "applessl" and not tools.apple.is_apple_os(self, self.settings.os):
