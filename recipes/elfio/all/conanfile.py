...
class ElfioConan(ConanFile):
    ...
    def source(self):
        get(self, **self.conan_data["sources"][self.version], trip_root=True)
        rename(self, "elfio-{}".format(self.version), self.source_folder)
    ...
    def package(self):
        ...
        copy(self, pattern=os.path.join("elfio", "*.hpp"), src=self.source_folder, dst="include")
