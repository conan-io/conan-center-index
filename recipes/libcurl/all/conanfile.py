...
class LibcurlConan(ConanFile):
    ...
    def _patch_cmake(self):
        ...
        if self.options.with_ssl == "libressl":
            replace_in_file(self, cmakelists, "find_package(OpenSSL REQUIRED)", "find_package(LibreSSL REQUIRED CONFIG)")
            replace_in_file(self, cmakelists, "OpenSSL::SSL OpenSSL::Crypto", "LibreSSL::SSL LibreSSL::Crypto")
            replace_in_file(self, cmakelists, "OPENSSL_LIBRARIES", "LibreSSL::SSL LibreSSL::Crypto")
            replace_in_file(self, cmakelists, "OPENSSL_INCLUDE_DIR", "LibreSSL_INCLUDE_DIRS")
