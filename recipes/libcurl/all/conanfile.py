...
class LibcurlConan(ConanFile):
    ...
    def _patch_cmake(self):
        ...
        if Version(self.version) < "8.18.0":
            location_fix_pattern = 'get_target_property(_lib "${_libname}" LOCATION)'
        ...
        # INTERFACE_LIBRARY targets doesn't have the LOCATION property.
        # So skip the LOCATION check in the CMakeLists.txt
        replace_in_file(
            self,
            cmakelists,
