...
class LibcurlConan(ConanFile):
    ...
    def _has_zstd_option(self):
        return tools.Version(self.original_version) >= "7.72.0"
    ...
    def configure(self):
        ...
        if self.options.with_ssl == "wolfssl" and self._is_using_cmake_build and tools.Version(self.original_version) < "7.70.0":
    ...
    def _configure_cmake(self):
        ...
        if tools.Version(self.original_version) >= "7.72.0":
        ...
        if tools.Version(self.original_version) >= "7.70.0":
    ...
    def package_info(self):
        ...
        if self.settings.os == "Linux":
            ...
            if tools.Version(self.original_version) >= "7.77.0":
