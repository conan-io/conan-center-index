...
class LibcurlConan(ConanFile):
    ...
    def config_options(self):
        ...
        # Default options
        self.options.with_ssl = "darwinssl" if tools.apple.is_apple_os(self) else "openssl"
    ...
    def validate(self):
        ...
        if self.options.with_ssl == "darwinssl" and not tools.apple.is_apple_os(self):
    ...
    def _configure_autotools(self):
        ...
        if cross_building(self) and tools.apple.is_apple_os(self):
    ...
    def _configure_cmake(self):
        ...
        elif tools.scm.Version(self.version) >= "7.72.0":
