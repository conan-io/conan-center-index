...
class BoostConan(ConanFile):
    ...
    def _ar(self):
        ...
        if tools.is_apple_os(self, self.settings.os) and self.settings.compiler == "apple-clang":
    ...
    def _toolset(self):
        ...
        if self.settings.os == "Emscripten" and self.settings.compiler == "clang":
            return "emscripten"
        if self.settings.compiler == "gcc" and tools.is_apple_os(self, self.settings.os):
            return "darwin"
        if self.settings.compiler == "apple-clang":
            return "clang-darwin"
    ...
    def package_info(self):
        ...
        if not self.options.header_only:
            ...
            if not self.options.without_stacktrace:
                ...
                elif tools.is_apple_os(self, self.settings.os) or self.settings.os == "FreeBSD":
