...
class MBedTLSConan(ConanFile):
    ...
    def configure(self):
        ...
        if tools.scm.Version(self.version) >= "2.23.0":
    ...
    def validate(self):
        ...
        if tools.scm.Version(self.version) >= "2.23.0" \
            and self.settings.compiler == "gcc" and tools.scm.Version(self.settings.compiler.version) < "5":
    ...
    def package(self):
        ...
        if tools.scm.Version(self.version) < "2.23.0": # less then 2.23 is multi-licensed
