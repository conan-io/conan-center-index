...
class OpenSubdivConan(ConanFile):
    ...
    def _patch_sources(self):
        ...
        # To depends of FindXXX.cmake generated by CMakeDeps instead of ones provided by opensubdiv
        if Version(self.version) == "3.6.0":
            replace_in_file(self, os.path.join(self.source_folder, "CMakeLists.txt"), """# Specify the list of directories to search for cmake modules.
list(APPEND CMAKE_MODULE_PATH
    ...
    def package_info(self):
        ...
        if self._osd_gpu_enabled:
            ...
            if self.options.get_safe("with_opengl"):
                self.cpp_info.components["osdgpu"].requires.append("opengl::opengl")
            if self.options.get_safe("with_metal"):
