...
class VolkConan(ConanFile):
    ...
    def requirements(self):
        self.requires("diligentgraphics-vulkan-headers/" + self.version)
    ...
    def package_info(self):
        ...
        self.cpp_info.components["libvolk"].requires = ["diligentgraphics-vulkan-headers::vulkanheaders"]
        ...
        self.cpp_info.components["volk_headers"].requires = ["diligentgraphics-vulkan-headers::vulkanheaders"]
        if self.settings.os == "Linux":
