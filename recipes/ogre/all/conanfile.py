...
class OgreConanFile(ConanFile):
    ...
    def _build_opengl(self):
        # https://github.com/OGRECave/ogre/blob/v14.1.2/RenderSystems/CMakeLists.txt#L32-L34
    ...
    def validate(self):
        ...
        # https://github.com/OGRECave/ogre/blob/v14.1.2/CMake/ConfigureBuild.cmake#L21-L25
    ...
    def generate(self):
        ...
        # https://github.com/OGRECave/ogre/blob/v14.1.2/CMakeLists.txt#L284-L423
        ...
        tc.cache_variables["OGRE_BUILD_COMPONENT_PYTHON"] = self.options.build_component_python
        tc.cache_variables["OGRE_BUILD_COMPONENT_JAVA"] = self.options.build_component_java
        tc.cache_variables["OGRE_BUILD_COMPONENT_CSHARP"] = self.options.build_component_csharp
        ...
        tc.cache_variables["OGRE_BUILD_SAMPLES"] = self.options.get_safe("build_samples", False)
        ...
        tc.cache_variables["OGRE_BUILD_PLUGIN_CG"] = self.options.get_safe("build_plugin_cg", False)
        ...
        tc.cache_variables["OGRE_CONFIG_ENABLE_GLES2_CG_SUPPORT"] = self.options.get_safe("config_enable_gles2_cg_support", False)
        ...
        tc.cache_variables["OGRE_INSTALL_SAMPLES"] = self.options.get_safe("build_samples", False)
        tc.cache_variables["OGRE_INSTALL_TOOLS"] = self.options.get_safe("build_tools", False)
        tc.cache_variables["OGRE_INSTALL_DOCS"] = self.options.get_safe("install_docs", False)
        tc.cache_variables["OGRE_INSTALL_PDB"] = self.options.get_safe("install_pdb", False)
        tc.cache_variables["OGRE_PROFILING"] = self.options.profiling
        tc.cache_variables["OGRE_LIB_DIRECTORY"] = "lib"
        tc.cache_variables["OGRE_BIN_DIRECTORY"] = "bin"
        tc.cache_variables["OGRE_INSTALL_VSPROPS"] = self.options.get_safe("install_vsprops", False)
        # https://github.com/OGRECave/ogre/blob/v14.1.2/CMake/ConfigureBuild.cmake#L63-L69
    ...
    def _format_lib(self, lib):
        # https://github.com/OGRECave/ogre/blob/v14.1.2/CMake/ConfigureBuild.cmake#L140-L145
