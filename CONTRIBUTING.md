...
2. Make sure to [request access](docs/adding_packages/how_to_add_packages.md#request-access) and be aware there is a [CLA](docs/CONTRIBUTOR_LICENSE_AGREEMENT.md).
3. Get setup by following the [Developing Recipes](docs/developing_recipes_locally.md) guide and learn the basic commands.
4. Check the [How To Add Packages](docs/adding_packages/how_to_add_packages.md) page for the break down of ConanCenterIndex specific conventions and practices.
...
6. [Submit a pull request](docs/adding_packages/how_to_add_packages.md#submitting-a-package) once you are ready. This can be when you
