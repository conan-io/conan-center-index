...
[Unlicense](https://spdx.org/licenses/Unlicense) should be used as described in the [FAQ](https://github.com/conan-io/conan-center-index/blob/master/docs/faqs.md#what-license-should-i-use-for-public-domain).
